...
export const CONFIG_PEER_DISCOVERY_GLOBAL = 'universal-connectivity-browser-peer-discovery'
export const CONFIG_PUBSUB_PEER_DISCOVERY = [CONFIG_PEER_DISCOVERY_UNIVERSAL_CONNECTIVITY,prefix+'-peer-discovery']
